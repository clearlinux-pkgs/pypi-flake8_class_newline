...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697489469
...
cp %{_builddir}/flake8-class-newline-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-flake8_class_newline/8aec8ab776c95f72ec18b58a7a68c81d4ddc8408 || :
